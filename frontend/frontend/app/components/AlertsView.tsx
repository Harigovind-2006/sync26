...
export default function AlertsView() {
  // Only show assets that have status === 'alert'
  const alertAssets = mockAssets.filter((a) => a.status === 'alert');
      ...
      <main className="flex-1 h-full min-h-0 overflow-y-auto p-8 space-y-6">
        ...
        {takedownNotice && (
          <div className="bg-red-950/90 text-red-200 px-5 py-3.5 border border-red-500/40 rounded-2xl flex items-center justify-between text-xs font-semibold">
            ...
            <button onClick={() => setTakedownNotice(null)} className="text-red-300 hover:text-white shrink-0 ml-4">
              <X className="w-4 h-4" />
            </button>
          </div>
        )}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-video overflow-hidden bg-slate-950">
                      ...
                      {/* Confidence Score Overlay (bottom) */}
                      {asset.confidence > 0 && (
                    ...
                    <div className="p-4 space-y-3 flex-1 flex flex-col">
                      ...
                      <div className="space-y-1.5 text-[11px]">
                        {asset.incidentUrl && (
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-red-400 font-mono flex items-center gap-1 hover:underline">
                      ...
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          handleCopy(asset.sha256, asset.id);
                        }}
                      >
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handleGenerateTakedown(asset);
                        }}
                        className="w-full mt-1 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 hover:border-red-500/60 text-red-400 font-bold text-[11px] py-2.5 rounded-xl transition-all flex items-center justify-center gap-2"
                      >
