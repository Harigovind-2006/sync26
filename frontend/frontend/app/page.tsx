...
import {
  ...
  Fingerprint, Shield, Lock, Sparkles, ArrowRight, Layers, Cpu, Camera, Palette
} from 'lucide-react';
...
export default function GalleryHomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#07070A] text-white font-sans overflow-x-hidden selection:bg-[#9b51e0] selection:text-black">
      {/* Fixed Ambient Glow Effects */}
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-[#9b51e0]/6 rounded-full blur-[220px]" />
        <div className="absolute bottom-[5%] right-[-10%] w-[700px] h-[700px] bg-[#00b0ff]/5 rounded-full blur-[200px]" />
      </div>

      {/* ══════════════════════════════════════════════════════
          1. TOP NAVIGATION BAR
      ══════════════════════════════════════════════════════ */}
      <header className="sticky top-0 z-50 h-20 border-b border-white/[0.06] bg-[#07070A]/85 backdrop-blur-xl transition-all">
        <div className="max-w-[1440px] mx-auto px-8 md:px-[80px] h-full flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#9b51e0] to-[#00b0ff] flex items-center justify-center text-black font-black text-lg shadow-lg shadow-[#9b51e0]/20 group-hover:scale-105 transition-transform">
              L
            </div>
            <span className="text-lg font-bold tracking-tight text-white">Lakxam Rekha</span>
          </Link>

          {/* Center Links */}
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            <Link href="/" className="text-white font-bold transition-colors">Home</Link>
            ...
            <Link href="/results" className="text-zinc-400 hover:text-white transition-colors">Results</Link>
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <Link
                href="/upload"
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#9b51e0] to-[#00b0ff] text-black font-bold text-xs hover:brightness-110 active:scale-[0.97] transition-all shadow-lg shadow-[#9b51e0]/20 flex items-center gap-2"
              >
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#9b51e0] to-[#00b0ff] text-black font-bold text-xs hover:brightness-110 active:scale-[0.97] transition-all shadow-lg shadow-[#9b51e0]/20"
                >
                  Get Started
                </Link>
              </>
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-24 right-10 z-50 px-4 py-3 rounded-xl bg-[#0d0d14] border border-[#9b51e0]/40 text-white text-xs font-semibold shadow-2xl flex items-center gap-3"
          >
      ...
      {/* ══════════════════════════════════════════════════════
          2. LARGE HERO BANNER (70-80% Viewport Height, 96% Width)
      ══════════════════════════════════════════════════════ */}
      ...
      ══════════════════════════════════════════════════════ */}
      <main className="relative z-10 max-w-[1440px] mx-auto px-6 sm:px-12 md:px-[80px] pt-[80px] pb-[60px] space-y-[40px]">
